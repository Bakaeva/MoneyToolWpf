...
namespace MoneyToolWpf
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            cbCurrency1.SelectionChanged += (sender, args) => SummaChanged(sender, args);
            tbSumma1.TextChanged += (sender, args) => SummaChanged(sender, args);
            cbCurrency2.SelectionChanged += (sender, args) => SummaChanged(sender, args);
            tbSumma2.TextChanged += (sender, args) => SummaChanged(sender, args);
